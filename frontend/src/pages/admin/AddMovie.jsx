    ...
    <div className="min-h-screen text-white">
      ...
      >
        ...
        />
                ...
                <button
  className="group relative overflow-hidden flex items-center gap-3 bg-[#FF4D00] px-6 py-3 rounded-2xl font-semibold shadow-[0_0_20px_rgba(255,77,0,0.35)] transition-all duration-300 hover:scale-105 hover:shadow-[0_0_35px_rgba(255,77,0,0.55)] md:col-span-2"
>
  {/* Glow */}
