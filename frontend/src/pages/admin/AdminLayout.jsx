      ...
      <div className="w-[290px] bg-white/[0.03] border-r border-white/10 backdrop-blur-xl flex flex-col justify-between p-6">
        ...
        <div>
          ...
          >
            ...
            <h1 className="text-3xl font-black italic text-[#FF4D00]">
              Admin
            </h1>
          </Link>
        ...
        {/* Logout */}
        <button className="flex items-center justify-center gap-3 w-full py-4 rounded-2xl bg-[#E61919] hover:bg-red-600 transition-all duration-300 font-semibold text-lg shadow-[0_0_25px_rgba(230,25,25,0.35)]">
